...
impl Prepare {
    pub fn try_execute(&mut self) -> Result<()> {
        ...
        // TODO barcodes should be in that struct
        let params_io = PrepareParams {
    ...
    pub fn prepare<'a>(
        ...
        let path_temp_incomplete_sorted = params_io
            .path_tmp
        ...
        catsort_files(&list_inputfiles, &params_io.path_output_incomplete, false);
...
// TODO refactor, move from prepare.rs (true for all functions below)
...
pub fn catsort_files(list_inputfiles: &Vec<PathBuf>, path_final: &PathBuf, sort: bool) {
    let use_bgzip = true;
