...
impl str::FromStr for crate::runtime::ErrorMode {
    type Err = String;

    fn from_str(s: &str) -> Result<Self, String> {
        let mode = match s.to_lowercase().as_str() {
            "supress" => crate::runtime::ErrorMode::Suppress,
            "skip" => crate::runtime::ErrorMode::Skip,
            "fail" => crate::runtime::ErrorMode::Fail,
            _ => return Err(format!("Invalid error mode: {}", s)),
        };
        Ok(mode)
    }
}
impl fmt::Display for crate::runtime::ErrorMode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let name = match self {
            crate::runtime::ErrorMode::Fail => "fail",
            crate::runtime::ErrorMode::Skip => "skip",
            crate::runtime::ErrorMode::Suppress => "suppress",
        };
        write!(f, "{}", name)
    }
}
