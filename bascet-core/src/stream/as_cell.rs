    ...
    D: crate::Decode + Send + 'static,
{
    ...
    where
        ...
        Self::Intermediate: crate::Get<Id>,
        C: crate::FromParsed<C::Attrs, Self::Intermediate>
            + crate::FromBacking<Self::Intermediate, C::Backing>,
    {
        self.next_by(|r1, r2| r1.get::<Id>() == r2.get::<Id>())
    }
...
impl<T> crate::NextBy<AsCell> for T
where
    T: crate::Next<AsCell>,
{
    ...
    where
        ...
        C: crate::Composite<Marker = AsCell> + Default,
        C: crate::FromParsed<C::Attrs, Self::Intermediate>
            + crate::FromBacking<Self::Intermediate, C::Backing>,
    {
        todo!("Implement next_by: parse records, use predicate to group them into a cell")
    }
}
